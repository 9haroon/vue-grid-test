<template>
  <div class="PrimaryPageLayout">
    <div class="Layout">
      <b-container fluid="sm" align-v="center" class="justify-content-center">
        <b-row align-v="center">
          <b-col cols="12" sm="12" lg="12"><Card></Card></b-col>
        </b-row>
      </b-container>
    </div>
  </div>
